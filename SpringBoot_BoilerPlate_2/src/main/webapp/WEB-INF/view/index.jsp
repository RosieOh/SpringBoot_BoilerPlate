...
<body>
    ...
    <button type="button" onclick="location.href='signup'" class="pure-button pure-button-primary">가입하기</button>

    <button type="button" onclick="location.href='update'" class="pure-button pure-button-primary">수정하기</button>
